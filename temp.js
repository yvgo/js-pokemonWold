function headerTemp() {
    return `<div class="header">
        <h1>World of Pokemons</h1>
        <div class="search">
            <img class="searchIcon" src="./img/icons/lupe.png">
            <input class="searchInput" placeholder="Search Pokemons" id="search" onkeydown="filterPoks()">
        </div>
    </div>
    `;
}
...
function footerTemp() {
    return /*html*/ `<div class="footer">
        <div class="footerElements">
            <button id="morePokemons" class="button" onclick="loadNextPokemons()">Load more Pokemons</button>
            <a href="#header"><button id="morePokemons" class="button">Up</button></a>
        </div>
    </div>
    `;
}
...
function allPokemonsTableTemp(i, currentPokemon) {
    return /*html*/ `
    <div id="singlePok${i}" class="singleBox" onclick="renderSinglePokemon(${i}, event)">
...
function pokemonInfoTemp(i) {
    ...
    <div id="dialog" class="dialog-bg" onclick="closeSinglePokemon(${i})">
        <div id="imgBox${i}" class="dialogBox" onclick="doNotClose(event)">
            <div class="navTop">
            ...
            <div class="cardHeader">
                <div class="figurePosition ">
                    <img id="figure" class="figSize" loading="lazy">
                </div>
            </div>
            <div class="infoContainer">
                ...
                <div id="pokInfo" class="pokInfo">
                    <div class="hstack gap-5">
                        ...
                        <div id="moveTab" class="tabText" onclick="renderMoves(${i}, event)">Moves</div>
                    </div>
                    <div class="details">
